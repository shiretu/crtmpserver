...
-- WebSocket protocols
CONF_PROTOCOL_INBOUND_WS_FMP4="inboundWSFMP4",
CONF_PROTOCOL_INBOUND_WSS_FMP4="inboundWSSFMP4",
...
CONF_PROTOCOL_INBOUND_WS_CLI_JSON="inboundWsJsonCli",
CONF_PROTOCOL_INBOUND_WSS_CLI_JSON="inboundWssJsonCli",

-- RPC protocols
CONF_PROTOCOL_OUTBOUND_RPC="outboundRpc",
CONF_PROTOCOL_OUTBOUND_SSL_RPC="outboundSslRpc",
CONF_PROTOCOL_OUTBOUND_HTTP_RPC="outboundHttpRpc",
CONF_PROTOCOL_OUTBOUND_HTTPS_RPC="outboundHttpsRpc",
CONF_PROTOCOL_OUTBOUND_WS_RPC="outboundWsRpc",
CONF_PROTOCOL_OUTBOUND_WSS_RPC="outboundWssRpc",

RPC_PROTOCOL_INPUT_SERIALIZER="inputSerializer",
RPC_PROTOCOL_OUTPUT_SERIALIZER="outputSerializer",
RPC_PROTOCOL_SERIALIZER_BINVAR="binVariant",
RPC_PROTOCOL_SERIALIZER_JSONVAR="jsonVariant",
RPC_PROTOCOL_SERIALIZER_XMLVAR="xmlVariant",
RPC_PROTOCOL_SERIALIZER_XML="arbitraryXml",
RPC_PROTOCOL_SERIALIZER_KVP="kvp",
...
CONF_APPLICATION_HAS_INGEST_POINTS="hasIngestPoints",
...
CONF_LOG_APPENDER_TYPE_JAVA="java",
